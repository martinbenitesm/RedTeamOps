...
Este proyecto documenta la implementación de un entorno de monitoreo y detección de amenazas en tiempo real utilizando **Wazuh SIEM**, **Sysmon** y una máquina víctima **Windows 10**. Se simularon dos vectores de ataque reales desde una máquina atacante **Kali Linux** para validar las capacidades de ingesta, detección, análisis de logs y correlación de eventos en un entorno SOC. Finalmente se presentan el informe correspondiente a este caso y una política de contraseñas y autenticación cuyo cumplimiento ayudaría a reducir estas vulnerabilidades. Se crearon 2 programas uno de fuerza bruta y otro de verificador de contraseñas para un correcto cumplimiento de politicas.
